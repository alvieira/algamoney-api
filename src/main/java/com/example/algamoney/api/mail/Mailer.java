...
public class Mailer {
	...
	//
	// this.enviarEmail("aloisio.vieira@gmail.com",
	// Arrays.asList("aloisio.vieira@gmail.com"), "Testando", template,
	// variaveis);
	...
	// private void teste(ApplicationReadyEvent event) {
	// this.enviarEmail("aloisio.vieira@gmail.com",
	// Arrays.asList("aloisio.vieira@gmail.com"),
	...
	public void avisarSobreLancamentosVencidos(List<Lancamento> vencidos, List<Usuario> destinatarios) {
		...
		this.enviarEmail("aloisio.vieira@gmail.com", emails, "Lançamentos vencidos", "mail/aviso-lancamentos-vencidos",
				variaveis);
